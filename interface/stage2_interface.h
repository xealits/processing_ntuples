...
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmu0ID)
...
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmuTRGUp)
...
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmuTRGctrlDown)
...
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmuIDDown)
...
Int_t_in_NTuple     (OUTNTUPLE, selection_stage_dy_mumu_TESDown)
...
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmuBTRG)
...
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPelTRGUp)
Int_t_in_NTuple     (OUTNTUPLE, selection_stage_em_TESUp)
...
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmuBID)
VECTOR_PARAMs_in_NTuple  (OUTNTUPLE, Float_t, event_jets_l_bSFweight)
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmuIDUp)
...
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmuTRGctrlUp)
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmu0TRGUp)
...
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmuHID)
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmuHTRG)
...
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPelIDDown)
...
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmu0TRG)
...
Int_t_in_NTuple     (OUTNTUPLE, selection_stage_dy_mumu_TESUp)
Float_t_in_NTuple   (OUTNTUPLE, event_met_lep_mt_init)
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEP_PU)
...
Float_t_in_NTuple   (OUTNTUPLE, event_weight_LEPmuTRGDown)
...
Int_t_in_NTuple     (OUTNTUPLE, selection_stage_em_TESDown)

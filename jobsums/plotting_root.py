...
"dy":          {'color': kGray+2,  'legend': 'Drell-Yan'},
...
"tt_elmu":       {'color': rgb(254,224,210),   'legend': 't#bar{t}#rightarrow e#nu_{e}#mu#nu_{#mu}b#bar{b}'},
"tt_taultauh":   {'color': rgb(253,141,60),    'legend': 't#bar{t}#rightarrow #tau_{l}#nu_{#tau}#tau_{h}#nu_{#tau}b#bar{b}'},
